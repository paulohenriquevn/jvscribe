...
| `asr-evidence-discipline.md` | Evidence contract for the `.claude/agents/` team — number provenance labels, hypothesis/evidence/conclusion split, the 12 invalidating fallacies, and the locked "discover contínuo" state |
