...
- Baseline sobre test set 8 kHz proxy (`scripts/run_baseline.py`): orquestra augmentação + WER, rejeita pseudo-label (invariante `PRD.md` § 7.3), emite relatório com rótulo `[MEDIDO]`
