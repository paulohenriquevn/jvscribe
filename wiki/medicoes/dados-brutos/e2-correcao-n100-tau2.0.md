---
type: Medição
title: E2 — correção pós-decode com portão (bruto, n=100, τ=2.0)
...
**Data:** 2026-07-31T18:26:33 · **Comando:** `python3 jvscribe/probes/portao_correcao_probe.py --corrigir --n 100 --tau 2.0`
**Amostra:** 100 utterances de FLEURS pt_br · τ = 2.0
...
| **consertou** | 8 |
| **quebrou** | 2 |
| neutro (errado antes, errado depois) | 19 |
...
- consertou: dividades→divindades, obcenidade→obscenidade, filalactelistas→filatelistas, lagatos→lagartos, radeo→radio, madagascare→madagascar, musquitos→mosquitos, openacao→operacao
