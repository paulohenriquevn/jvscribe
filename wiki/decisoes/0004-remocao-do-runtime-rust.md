---
type: ADR
title: Remoção do runtime Rust
description: Decisão por foco de time, não por performance — a comparação justa mostrou os dois indistinguíveis.
tags: [adr, runtime, rust, python]
