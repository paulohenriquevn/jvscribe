...
# training/results/onnx/tokens.txt. O Python DEVE reproduzi-lo bit a bit — é o teste de
...
def test_fingerprint_python_reproduz_o_do_rust():
    ...
    tokens = REPO / "training/results/onnx/tokens.txt"
...
def test_eval_public_hf_nao_tem_caminho_absoluto():
    ...
    src = (REPO / "training/batch/eval_public_hf.py").read_text(encoding="utf-8")
